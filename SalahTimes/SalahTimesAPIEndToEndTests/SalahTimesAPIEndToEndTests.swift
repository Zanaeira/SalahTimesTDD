...
class SalahTimesAPIEndToEndTests: XCTestCase {
	...
	private func makeSUT(file: StaticString = #file, line: UInt = #line) -> (salahTimesLoader: RemoteLoader<SalahTimes>, endpoint: Endpoint) {
		...
		let salahTimesLoader = RemoteLoader(client: client, mapper: SalahTimesMapper.map)
